...
namespace Nop.Admin.Controllers
{
    ...
    public partial class ProductVariantController : BaseNopController
    {
        ...
        public ProductVariantController(IProductService productService,
            ...
            IMeasureService measureService, MeasureSettings measureSettings, IImportManager importManager,
        ...
        public ActionResult Create(ProductVariantModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                variant.ColorCode = Request["hdfColorCode"];
                //insert variant
            ...
            if (updatedProductVariants != null)
            {
                foreach (var pvModel in updatedProductVariants)
                {
                    ...
                    if (pv != null)
                    {
                        ...
                        pv.Sku = pvModel.Sku;
                        pv.ColorCode = pvModel.ColorCode;
        ...
        public ActionResult ImportPrice()
        {
            ...
            try
            {
                ...
                {
                    importLog = _importManager.ImportProductPricesFromXlsx(file.InputStream);
                }
                else
                {
                    ErrorNotification(_localizationService.GetResource("Admin.Common.UploadFile"));
                    return RedirectToAction("BulkEdit");
                }
                SuccessNotification(_localizationService.GetResource("Admin.Catalog.ProductPrices.Imported") + "<br />IMPORT LOG:<br />" + importLog);
                return RedirectToAction("BulkEdit");
            }
            catch (Exception exc)
            {
