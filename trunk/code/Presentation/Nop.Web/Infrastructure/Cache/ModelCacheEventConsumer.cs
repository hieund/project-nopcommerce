...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeleted<StateProvince>>
    {
        ...
        /// <summary>
        /// Key for product identifiers displayed on the home page
        /// </summary>
        public const string HOMEPAGE_PRODUCTS = "Nop.pres.products.homepage";
        public const string HOMEPAGE_PRODUCTS_MODEL = "Nop.pres.products.homepage.model";

        /// <summary>
        /// Key for product collection identifiers displayed on the home page
        /// </summary>
        public const string HOMEPAGE_COLLECTIONS = "Nop.pres.collections.homepage";
        public const string HOMEPAGE_COLLECTIONS_MODEL = "Nop.pres.collections.homepage.model";
        public const string HOMEPAGE_PRODUCT_COLLECTIONS_IDS_KEY = "Nop.pres.productcollections.homepage-{0}";
        public const string HOMEPAGE_PRODUCT_COLLECTIONS_IDS_PATTERN_KEY = "Nop.pres.productcollections.homepage";
        ...
        /// <summary>
        /// Key for default news picture caching
        /// </summary>
        /// <remarks>
        /// {0} : news id
        /// {1} : news size
        /// {2} : value indicating whether a default picture is displayed in case if no real picture exists
        /// {3} : language ID ("alt" and "title" can depend on localized news title)
        /// {4} : is connection SSL secured?
        /// </remarks>
        public const string NEWS_DEFAULTPICTURE_MODEL_KEY = "Nop.pres.news.picture-{0}-{1}-{2}-{3}-{4}";
        public const string NEWS_DEFAULTPICTURE_PATTERN_KEY = "Nop.pres.news.picture";
        ...
        public void HandleEvent(EntityUpdated<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(HOMEPAGE_PRODUCT_COLLECTIONS_IDS_PATTERN_KEY);
            _cacheManager.RemoveByPattern(HOMEPAGE_PRODUCTS);
            _cacheManager.RemoveByPattern(HOMEPAGE_PRODUCTS_MODEL);
            _cacheManager.RemoveByPattern(HOMEPAGE_COLLECTIONS);
            _cacheManager.RemoveByPattern(HOMEPAGE_COLLECTIONS_MODEL);
