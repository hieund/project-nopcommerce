    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("AddProductToCompare",
                            "so-sanh/them/{productId}",
                            new { controller = "Catalog", action = "AddProductToCompareList" },
                            new { productId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
           

            //routes.MapLocalizedRoute("CompareProductsList",
            //                "compareproducts/list/{productIds}",
            //                new { controller = "Catalog", action = "CompareProducts" },
            //                new[] { "Nop.Web.Controllers" });

             routes.MapLocalizedRoute("CompareProducts",
                            "so-sanh/{productIds}",
                            new { controller = "Catalog", action = "CompareProducts", productIds = UrlParameter.Optional },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("RemoveProductFromCompareList",
                            "so-sanh/xoa/{productId}",
                            new { controller = "Catalog", action = "RemoveProductFromCompareList" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("ClearCompareList",
                            "xoa-danh-sach-so-sanh/",
                            new { controller = "Catalog", action = "ClearCompareList" },
                            new[] { "Nop.Web.Controllers" });
            //product color
            routes.MapLocalizedRoute("ChangeProductVariantColor",
                            "ChangeProductVariantColor/{intProductVariantId}",
                            new { controller = "Catalog", action = "ChangeProductVariantColor" },
                            new { intProductVariantId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            //card quick order
            routes.MapLocalizedRoute("CardQuickOrder",
                            "quickorder/{intProductVariantId}",
                            new { controller = "Checkout", action = "CardQuickOrder" },
                            new { intProductVariantId = @"\d+"},
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CardQuickOrderSubmit",
                            "quickordersubmit",
                            new { controller = "Checkout", action = "CardQuickOrderSubmit" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("ContactUs",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //other pages
            routes.MapLocalizedRoute("ListStore",
                            "he-thong-cua-hang",
                            new { controller = "Common", action = "ListStore" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("TopicPopup",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("TopicPopup_VN",
                            "bai-viet-popup/{SystemName}",
                            new { controller = "Topic", action = "TopicDetailsPopup" },
                            new[] { "Nop.Web.Controllers" });
            //sitemaps
