    ...
    public class WidgetsNivoSliderController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.Content1_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.Content1, storeScope);
                ...
                model.Content2_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.Content2, storeScope);
                ...
                model.Content3_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.Content3, storeScope);
                ...
                model.Content4_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.Content4, storeScope);
        ...
        public ActionResult Configure(ConfigurationModel model)
        {
            ...
            if (model.Content1_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(nivoSliderSettings, x => x.Content1, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(nivoSliderSettings, x => x.Content1, storeScope);
            ...
            if (model.Content2_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(nivoSliderSettings, x => x.Content2, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(nivoSliderSettings, x => x.Content2, storeScope);
            ...
            if (model.Content3_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(nivoSliderSettings, x => x.Content3, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(nivoSliderSettings, x => x.Content3, storeScope);
            ...
            if (model.Content4_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(nivoSliderSettings, x => x.Content4, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(nivoSliderSettings, x => x.Content4, storeScope);
        ...
        {
            var nivoSliderSettings = _cacheManager.Get("Nop.Plugin.Widgets.NivoSlider.PublicInfo", () => _settingService.LoadSetting<NivoSliderSettings>(_storeContext.CurrentStore.Id));
