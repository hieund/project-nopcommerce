...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageGames = new PermissionRecord { Name = "Admin area. Manage Games", SystemName = "ManageGames", Category = "Games" };
        public static readonly PermissionRecord ExecuteGames = new PermissionRecord { Name = "Admin area. Execute Games", SystemName = "ExecuteGames", Category = "Games" };
