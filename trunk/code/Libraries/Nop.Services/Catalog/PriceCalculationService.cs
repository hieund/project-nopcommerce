...
namespace Nop.Services.Catalog
{
    ...
    public partial class PriceCalculationService : IPriceCalculationService
    {
        ...
        public virtual ProductVariant GetProductVariantWithMinimalPrice(IList<ProductVariant> variants,
            Customer customer, bool includeDiscounts, int quantity, out decimal? minPrice, bool isSearch = false)
        {
            minPrice = null;
            if (variants == null)
            ...
            if (!isSearch)
                variants = variants.Where(v => v.Price > 0).ToList();
        ...
        {
            return GetProductVariantWithMinimalPrice(variants, customer, includeDiscounts, quantity, out minPrice, false);
        }
        /// <summary>
