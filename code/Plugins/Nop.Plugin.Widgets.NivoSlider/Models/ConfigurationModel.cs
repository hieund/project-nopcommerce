...
namespace Nop.Plugin.Widgets.NivoSlider.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Content")]
        [AllowHtml]
        public string Content1 { get; set; }
        public bool Content1_OverrideForStore { get; set; }
        ...
        public bool Content2_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Link")]
        [AllowHtml]
        ...
        public bool Content3_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Link")]
        [AllowHtml]
        ...
        public bool Content4_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Link")]
        [AllowHtml]
