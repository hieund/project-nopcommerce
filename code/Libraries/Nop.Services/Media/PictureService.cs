...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        /// <summary>
        /// Gets pictures by news identifier
        /// </summary>
        /// <param name="productId">news identifier</param>
        /// <returns>Pictures</returns>
        public virtual IList<Picture> GetPicturesByNewsId(int newsId)
        {
            return GetPicturesByNewsId(newsId, 0);
        }
        ...
        /// <param name="recordsToReturn">Number of records to return. 0 if you want to get all items</param>
        /// <returns>Pictures</returns>
        public virtual IList<Picture> GetPicturesByNewsId(int newsId, int recordsToReturn)
        {
            if (newsId == 0)
                return new List<Picture>();
