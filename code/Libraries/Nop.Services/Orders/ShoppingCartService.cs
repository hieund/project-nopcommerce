...
namespace Nop.Services.Orders
{
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
        ...
        /// <param name="automaticallyAddRequiredProductVariantsIfEnabled"></param>
        /// <param name="cartitem"></param>
        /// <returns></returns>
        public virtual IList<string> AddQuickToCart(Customer customer, ProductVariant productVariant,
            ShoppingCartType shoppingCartType, int storeId, string selectedAttributes,
            decimal customerEnteredPrice, int quantity, bool automaticallyAddRequiredProductVariantsIfEnabled, ref ShoppingCartItem cartitem)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
