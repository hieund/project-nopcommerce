...
namespace Nop.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseNopEntityModel
    {
        public ProductDetailsModel()
        {
            ...
            ProductConfigModels = new List<ProductConfigModel>();
        }

        public string Name { get; set; }
        public string ShortDescription { get; set; }
        public string FullDescription { get; set; }
        public string HtmlSpec { get; set; }
        ...
        public string MetaOgImg { get; set; }
        ...
        //product detail
        public IList<ProductConfigModel> ProductConfigModels { get; set; }
        ...
        public partial class ProductVariantModel : BaseNopEntityModel
        {
            public ProductVariantModel()
            {
                ...
                ProductVariantColor = new ProductVariantColorModel();
            ...
            public ProductVariantColorModel ProductVariantColor { get; set; }
            ...
            public partial class ProductVariantColorModel : BaseNopModel
            {
                public string ColorCode { get; set; }
                public int ProductVariantId { get; set; }
            }
