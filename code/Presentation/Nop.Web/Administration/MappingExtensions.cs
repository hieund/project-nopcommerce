...
namespace Nop.Admin
{
    public static class MappingExtensions
    {
        ...
        #region promotion
        //news category
        public static PromotionModel ToModel(this Promotion entity)
        {
            return Mapper.Map<Promotion, PromotionModel>(entity);
        }

        public static Promotion ToEntity(this PromotionModel model)
        {
            return Mapper.Map<PromotionModel, Promotion>(model);
        }

        public static Promotion ToEntity(this PromotionModel model, Promotion destination)
        {
            return Mapper.Map(model, destination);
        }
        #endregion
        ...
        public static LuckyBoxModel ToModel(this LuckyBox entity)
        {
            return Mapper.Map<LuckyBox, LuckyBoxModel>(entity);
        }
        public static LuckyBox ToEntity(this LuckyBoxModel model)
        {
            return Mapper.Map<LuckyBoxModel, LuckyBox>(model);
        }
        public static LuckyBox ToEntity(this LuckyBoxModel model, LuckyBox destination)
        {
            return Mapper.Map(model, destination);
        }

        public static LuckyBoxDetailModel ToModel(this LuckyBoxDetail entity)
        {
            return Mapper.Map<LuckyBoxDetail, LuckyBoxDetailModel>(entity);
        }

        public static LuckyBoxDetail ToEntity(this LuckyBoxDetailModel model, LuckyBoxDetail destination)
        {
            return Mapper.Map(model, destination);
        }
