...
namespace Nop.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.RegisterType<NewsCategoryService>().As<INewsCategoryService>().InstancePerHttpRequest();
            ...
            //Game, e.g: LuckyBox
            builder.RegisterType<LuckyBoxService>().As<ILuckyBoxService>().InstancePerHttpRequest();

            //Promotion
            builder.RegisterType<PromotionService>().As<IPromotionService>().InstancePerHttpRequest();
